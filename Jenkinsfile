                 ...
                 transfers: [
                  sshTransfer(
                   ...
                   execCommand: """
                    ...
                    docker tag springbootapp1 caxabi/springbootapp1:1.0
                    docker push caxabi/springbootapp1:1.0 """
                  )
                 ])
               ])
             }
                 ...
                 transfers: [
                  sshTransfer(
                   ...
                   execCommand: """
                    ...
                    sudo docker run -d -p 8090:8080 caxabi/springbootapp1:1.0; """
                  )
                 ])
               ])
             }
